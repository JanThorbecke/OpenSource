...
"   migdt=dt .......... Temporal cross-correlation sampling rate",
...
"   compress=0 ........ Compress stored snapshots to reduce",
"                       memory usage at the cost of compute",
"                       time. Set to non-zero for compression.",
"",
" SNAPSHOT INFORMATION:",
"   tsnap1=0.1 ........ First snapshot time",
"   tsnap2=0.0 ........ Last snapshot time",
"   dtsnap=0.1 ........ Snapshot temporal sampling rate",
...
"   decomp_med=3 ...... 2D Mediam Filter Size",
...
int main(int argc, char **argv){
	...
	rcv.ind=NULL;rcv.xi=NULL;rcv.zi=NULL;rcv.x=NULL;rcv.z=NULL;
	mig.wav=NULL;
...
//	}
	...
	if(decomp.decomp){
		...
		//will write out uninitialized values otherwise. The boundaries
...
//			if(sna.beam) getBeamTimes(mod,sna,vx,vz,tzz,txx,txz,beam_vx,beam_vz,beam_txx,beam_tzz,beam_txz,beam_p,beam_pp,beam_ss,verbose);
	...
	/* Export Migrated Image */
	/*************************/
	if(mig.mode) writeMigImage(&mod,&mig);
...
//		free(mod.tep);
	...
	/* Clean Up Compression Arguments */
	deallocateCompressionField();
